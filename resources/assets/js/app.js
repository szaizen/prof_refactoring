...
//モーダルを閉じる
$(document).on("click", ".modal__overlay,#modal__close", function () {
	$(".modal__content,.modal__overlay").fadeOut("slow");
	$('modal__content-text').text();
});

$('.js-game__item--1').on('click',function(){
...
$('.js-game__item--2').on('click',function(){
...
$('.js-game__item--3').on('click',function(){
...
$('.js-study__item--1').on('click',function(){
...
$('.js-study__item--2').on('click',function(){
...
$('.js-study__item--3').on('click',function(){
