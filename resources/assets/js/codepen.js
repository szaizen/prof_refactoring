...
<div class="work--list-modal">
  <div class="work--list-left">
    ...
    <div class="image--pc">
      <img src="assets/images/enclass.png" class="image--scroll">
    </div>
  </div>
  <div class="work--list-right">
    <p class="work--list-title"> コミュニティ「Enclass」／ ブログ、イベント </p>
...
<img src="assets/images/display-sp.png" class="image--display display--sp">
	...
	<div class="work--list-right">
		<p class="work--list-title">
			「パソナテックシステムズ」／コーポレートサイトリニューアル
		</p>
		<p class="work--list-detail">
			URL：<a href="	https://systems.pasonatech.co.jp/" target="_blank">https://systems.pasonatech.co.jp/</a><br>
			担当分野：メインデザイン、フロント開発<br>
			使用ツール：Wordpress,asana,slack,AdobeXD<br>
			開発内容：プロトタイプを作成し、デザインの考案。サイト内に使用する写真の選別。HTML,CSSやプラグインを使用してフロントのスタイル調整。<br>
			開発期間：約3か月間<br>
		</p>
	</div>
</div>
...
<img src="assets/images/display-sp.png" class="image--display display--sp">
    <div class="image--pc">
      <img src="assets/images/music_pc.png" class="image--scroll">
    </div>
  </div>
  <div class="work--list-right">
    <p class="work--list-title">
    ...
    <p class="work--list-detail">
			プロジェクト人数：1名<br>
    	使用ツール：Salesforce<br>
    	開発内容：Apex、Visualforceをフルスクラッチ開発し、ログイン機能・ユーザ登録機能・カート機能を実装。<br>
    	開発期間：約1か月間<br>
    	<a style="margin: 0 10px;" href="https://github.com/szaizen/music" target="_blank">Github</a><a style="margin: 0 10px;" href="https://qiita.com/szaizen/items/83f58c344c4478bb1520" target="_blank">Qiita</a>
    </p>
  </div>
</div>
*/
...
<img src="assets/images/display-sp.png" class="image--display display--sp">
    <div class="image--pc">
      <img src="assets/images/signpost.png" class="image--scroll">
    </div>
  </div>
  <div class="work--list-right">
    <p class="work--list-title">
    ...
    <p class="work--list-detail">
			URL：<a href="http://signpost.anotherworks.co.jp/" target="_blank">http://signpost.anotherworks.co.jp/</a><br>
			開発人数：1名<br>
    	使用ツール：Wordpress<br>
...
<img src="assets/images/display-sp.png" class="image--display display--sp">
    <div class="image--pc">
      <img src="assets/images/anotherworks.png" class="image--scroll">
    </div>
  </div>
  <div class="work--list-right">
    <p class="work--list-title">
    ...
    <p class="work--list-detail">
      URL：<a href="https://aw-anotherworks.com/" target="_blank">https://aw-anotherworks.com/</a><br>
      開発内容：ランディングページを作成<br>
      開発期間：約3日<br>
    </p>
  </div>
</div>
